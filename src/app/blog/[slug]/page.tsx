...
export default async function Page({
  ...
  return (
    <article className="w-full max-w-screen-md mx-auto px-6 py-20 text-balance prose prose-invert prose-a:link prose-headings:font-bold prose-headings:tracking-tight">
      ...
      <div className="space-y-5 mt-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="m-0 text-sm text-gray-500">{data.date}</p>
          </div>
        </div>
      </div>
      <div>
