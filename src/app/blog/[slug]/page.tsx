...
export default async function Page({
  ...
  return (
    <article className="w-full max-w-(--breakpoint-md) mx-auto px-6 py-20 text-balance prose prose-black dark:prose-invert prose-a:link prose-headings:font-semibold prose-headings:tracking-tight">
