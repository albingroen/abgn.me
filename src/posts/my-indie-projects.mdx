...
tags: ["indie-hacking", "business", "entrepreneur"]
image: https://res.cloudinary.com/albin-groen/image/upload/q_auto,w_800,f_auto/v1609100703/testifier-seo-image_gqcaiq.png
---

# Table of Contents

- [Render My Markdown (Live)](#render-my-markdown)
- [referrer.sh (Live)](#referrer-sh)
...
<h2 id="render-my-markdown">Render My Markdown</h2>
...
[Click here to go to the product →](https://github.com/albingroen/render-my-markdown)

![Render My Markdown banner image](https://res.cloudinary.com/albin-groen/image/upload/f_auto/v1609528887/rmmd-seo_yyselm.png)

<h2 id="referrer-sh">referrer.sh</h2>
...
[Click here to go to the product →](https://referrer.sh)

![referrer.sh landing page screenshot](https://res.cloudinary.com/albin-groen/image/upload/f_auto/v1609100703/testifier-seo-image_gqcaiq.png)

<h2 id="secretely">Secretely</h2>
...
<h2 id="keyboardnotes">Keyboardnotes</h2>
...
I built this web application for myself to get a note taking platform where I can simply take notes. Nothing else. Nothing more than that. Notes, entirely through my keyboard. With this tool, keyboard heavy users can take notes without touching their mouse. It's blazing fast, without any special terms like _"cards", "stories", or "pages"_.
...
<h2 id="cryptoprices">Cryptoprices</h2>
...
[Click here to go to the product →](https://cryptoprices.vercel.app)
